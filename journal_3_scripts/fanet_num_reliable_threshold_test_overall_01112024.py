...
if __name__ == "__main__":
    ...
    SAVE_PATH = "/home/research-student/omnet-fanet/data-processing-scripts/journal_3_scripts/results_new/num_reliable_failure_detection_overall_results_100_runs.csv"
    CONF_MAT_PATH = "/home/research-student/omnet-fanet/data-processing-scripts/journal_3_scripts/results_new/num_reliable_failure_detection_conf_matrix_100_runs.csv"
    FN_SAVE_PATH = ["/home/research-student/omnet-fanet/data-processing-scripts/journal_3_scripts/results_new/num_reliable_failure_detection_uav_0_fn_100_runs.csv",
                    "/home/research-student/omnet-fanet/data-processing-scripts/journal_3_scripts/results_new/num_reliable_failure_detection_uav_1_fn_100_runs.csv",
                    "/home/research-student/omnet-fanet/data-processing-scripts/journal_3_scripts/results_new/num_reliable_failure_detection_uav_2_fn_100_runs.csv",
                    "/home/research-student/omnet-fanet/data-processing-scripts/journal_3_scripts/results_new/num_reliable_failure_detection_manet_1_fn_100_runs.csv",
                    "/home/research-student/omnet-fanet/data-processing-scripts/journal_3_scripts/results_new/num_reliable_failure_detection_manet_a_fn_100_runs.csv",
                    "/home/research-student/omnet-fanet/data-processing-scripts/journal_3_scripts/results_new/num_reliable_failure_detection_manet_2_fn_100_runs.csv"]
    ...
    for datasets in DATASET_INT_PATHS:
        ...
        # ul_num_reliable_df["GW_UL_Failure_Predict"] = ul_num_reliable_df["UL_Failure_Predict"] | ul_num_reliable_df["GW_Failure_Predict"]
        # ul_num_reliable_df["GW_UL_Failure_Occur"] = ul_num_reliable_df["UL_Failure_Occur"] | ul_num_reliable_df["GW_Failure_Occur"]
        ...
        # gw_ul_tn, gw_ul_fp, gw_ul_fn, gw_ul_tp = confusion_matrix(ul_num_reliable_df["GW_UL_Failure_Occur"].values, ul_num_reliable_df["GW_UL_Failure_Predict"].values, labels=[0,1]).ravel()
        ...
        # ul_tn, ul_fp, ul_fn, ul_tp = confusion_matrix(ul_num_reliable_df["UL_Failure_Occur"].values, ul_num_reliable_df["UL_Failure_Predict"].values, labels=[0,1]).ravel()
        # ul_sensitivity = ul_tp / (ul_tp + ul_fn)
        # ul_specificity = ul_tn / (ul_tn + ul_fp)
        # ul_accuracy = accuracy_score(ul_num_reliable_df["UL_Failure_Occur"].values, ul_num_reliable_df["UL_Failure_Predict"].values)

        # dl_tn, dl_fp, dl_fn, dl_tp = confusion_matrix(ul_num_reliable_df["DL_Failure_Occur"].values, ul_num_reliable_df["DL_Failure_Predict"].values, labels=[0,1]).ravel()
        # dl_sensitivity = dl_tp / (dl_tp + dl_fn)
        # dl_specificity = dl_tn / (dl_tn + dl_fp)
        # dl_accuracy = accuracy_score(ul_num_reliable_df["DL_Failure_Occur"].values, ul_num_reliable_df["DL_Failure_Predict"].values)

        # gw_tn, gw_fp, gw_fn, gw_tp = confusion_matrix(ul_num_reliable_df["GW_Failure_Occur"].values, ul_num_reliable_df["GW_Failure_Predict"].values, labels=[0,1]).ravel()
        # gw_sensitivity = gw_tp / (gw_tp + gw_fn)
        # gw_specificity = gw_tn / (gw_tn + gw_fp)

        # uav_1_tn, uav_1_fp, uav_1_fn, uav_1_tp = confusion_matrix(ul_num_reliable_df["UAV_1_Failure_Occur"].values, ul_num_reliable_df["UAV_1_Failure_Predict"].values, labels=[0,1]).ravel()
        # uav_1_sensitivity = uav_1_tp / (uav_1_tp + uav_1_fn)
        # uav_1_specificity = uav_1_tn / (uav_1_tn + uav_1_fp)

        # uav_2_tn, uav_2_fp, uav_2_fn, uav_2_tp = confusion_matrix(ul_num_reliable_df["UAV_2_Failure_Occur"].values, ul_num_reliable_df["UAV_2_Failure_Predict"].values, labels=[0,1]).ravel()
        # uav_2_sensitivity = uav_2_tp / (uav_2_tp + uav_2_fn)
        # uav_2_specificity = uav_2_tn / (uav_2_tn + uav_2_fp)

        # uav_3_tn, uav_3_fp, uav_3_fn, uav_3_tp = confusion_matrix(ul_num_reliable_df["UAV_3_Failure_Occur"].values, ul_num_reliable_df["UAV_3_Failure_Predict"].values, labels=[0,1]).ravel()
        # uav_3_sensitivity = uav_3_tp / (uav_3_tp + uav_3_fn)
        # uav_3_specificity = uav_3_tn / (uav_3_tn + uav_3_fp)
        
        # uav_4_tn, uav_4_fp, uav_4_fn, uav_4_tp = confusion_matrix(ul_num_reliable_df["UAV_4_Failure_Occur"].values, ul_num_reliable_df["UAV_4_Failure_Predict"].values, labels=[0,1]).ravel()
        # uav_4_sensitivity = uav_4_tp / (uav_4_tp + uav_4_fn)
        # uav_4_specificity = uav_4_tn / (uav_4_tn + uav_4_fp)

        # uav_5_tn, uav_5_fp, uav_5_fn, uav_5_tp = confusion_matrix(ul_num_reliable_df["UAV_5_Failure_Occur"].values, ul_num_reliable_df["UAV_5_Failure_Predict"].values, labels=[0,1]).ravel()
        # uav_5_sensitivity = uav_5_tp / (uav_5_tp + uav_5_fn)
        # uav_5_specificity = uav_5_tn / (uav_5_tn + uav_5_fp)

        # uav_6_tn, uav_6_fp, uav_6_fn, uav_6_tp = confusion_matrix(ul_num_reliable_df["UAV_6_Failure_Occur"].values, ul_num_reliable_df["UAV_6_Failure_Predict"].values, labels=[0,1]).ravel()
        # uav_6_sensitivity = uav_6_tp / (uav_6_tp + uav_6_fn)
        # uav_6_specificity = uav_6_tn / (uav_6_tn + uav_6_fp)

        # uav_7_tn, uav_7_fp, uav_7_fn, uav_7_tp = confusion_matrix(ul_num_reliable_df["UAV_7_Failure_Occur"].values, ul_num_reliable_df["UAV_7_Failure_Predict"].values, labels=[0,1]).ravel()
        ...
        overall_fn_cases = ul_num_reliable_df.loc[(ul_num_reliable_df["Failure_Occur"] == 1) & (ul_num_reliable_df["Failure_Predict"] == 0)]
