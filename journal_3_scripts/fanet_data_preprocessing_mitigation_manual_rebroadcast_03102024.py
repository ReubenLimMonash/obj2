...
def compile_micro_sim_data_v2(file_list, video=False):
    ...
    if not video:
        ...
        return rx_df_list, tx_df_list, pd_df_list, br_df_list, mon_df_list, video_df_list
...
def process_scenario_broadcast(scenario_path, save_path, max_hdist_df, num_processes, 
    ...
    with Pool(num_processes) as pool:
        for result in pool.starmap(process_run, zip(run_number, repeat(run_file_path), repeat(uav_speed), repeat(max_hdist), 
            ...
            metric_list.append({"Run": result[0], "Num_Pkts_Reliable_DL": result[3], "Num_Pkts_Reliable_UL": result[4], "Num_Pkts_Reliable_VID": result[5], 
                            "Num_Broadcast_DL": result[1], "Num_Broadcast_UL": result[2],
                            "Useful_Packet_Reception_Ratio_DL": result[9], "Total_Reliability_DL": result[6], "Total_Reliability_UL": result[7], "Total_Reliability_VID": result[8], 
                            "DL_Num_Delay_Excd": result[10], "UL_Num_Delay_Excd": result[11], "VID_Num_Delay_Excd": result[12], 
                            "UL_Num_Incr_Rcvd": result[13], "VID_Num_Incr_Rcvd": result[14], "UL_Num_Queue_Overflow": result[15], "VID_Num_Queue_Overflow": result[16]}) 
...
def process_run(run_number, file_path, uav_speed, max_hdist,
    ...
    if vid_delay_threshold == 0:
        rx_df_list, tx_df_list, pd_df_list, br_df_list, mon_df_list = compile_micro_sim_data_v2(run_files, video=False)
    elif vid_delay_threshold > 0:
        rx_df_list, tx_df_list, pd_df_list, br_df_list, mon_df_list, video_df_list = compile_micro_sim_data_v2(run_files, video=True)
    ...
    if vid_delay_threshold > 0:
        ...
        if max_hdist != None:
            video_tx_df = video_tx_df.loc[video_tx_df["TxTime"] <= max_time]
            video_rx_df = video_rx_df.loc[video_rx_df["TxTime"] <= max_time]
            video_pd_df = video_pd_df.loc[video_pd_df["RxTime"] <= max_time]
    ...
    return (run_number, num_broadcasts_dl, num_broadcasts_ul, dl_num_reliable, ul_num_reliable, vid_num_reliable, total_reliability_dl, total_reliability_ul, vid_reliability, uprr_dl,
            dl_num_delay_excd, ul_num_delay_excd, vid_num_delay_excd, ul_num_incr_rcvd, vid_num_incr_rcvd, ul_num_queue_overflow, vid_num_queue_overflow)
...
if __name__ == "__main__":
    ...
    sim_root_paths = ["/media/research-student/KingstonSSD/FANET_Dataset/Manual_Rebroadcast_Exp/TH_RL10ms_MaxBr7/uav_scenario_0",
                      "/media/research-student/KingstonSSD/FANET_Dataset/Manual_Rebroadcast_Exp/TH_RL10ms_MaxBr7/uav_scenario_1",
                      "/media/research-student/KingstonSSD/FANET_Dataset/Manual_Rebroadcast_Exp/TH_RL10ms_MaxBr7/uav_scenario_2",
                      "/media/research-student/KingstonSSD/FANET_Dataset/Manual_Rebroadcast_Exp/TH_RL10ms_MaxBr7/manet_scenario_0",
                      "/media/research-student/KingstonSSD/FANET_Dataset/Manual_Rebroadcast_Exp/TH_RL10ms_MaxBr7/manet_scenario_1",
                      "/media/research-student/KingstonSSD/FANET_Dataset/Manual_Rebroadcast_Exp/TH_RL10ms_MaxBr7/manet_scenario_2"]
    save_paths = ["/media/research-student/KingstonSSD/FANET_Dataset/Manual_Rebroadcast_Exp/TH_RL10ms_MaxBr7/uav_scenario_0_processed",
                      "/media/research-student/KingstonSSD/FANET_Dataset/Manual_Rebroadcast_Exp/TH_RL10ms_MaxBr7/uav_scenario_1_processed",
                      "/media/research-student/KingstonSSD/FANET_Dataset/Manual_Rebroadcast_Exp/TH_RL10ms_MaxBr7/uav_scenario_2_processed",
                      "/media/research-student/KingstonSSD/FANET_Dataset/Manual_Rebroadcast_Exp/TH_RL10ms_MaxBr7/manet_scenario_0_processed",
                      "/media/research-student/KingstonSSD/FANET_Dataset/Manual_Rebroadcast_Exp/TH_RL10ms_MaxBr7/manet_scenario_1_processed",
                      "/media/research-student/KingstonSSD/FANET_Dataset/Manual_Rebroadcast_Exp/TH_RL10ms_MaxBr7/manet_scenario_2_processed"]
    
    dl_delay_threshold = 0.04
    ul_delay_threshold = 0.04
    vid_delay_threshold = 1
    ...
    for sim_root_path, save_path in zip(sim_root_paths, save_paths):
        ...
        for scenario_path in scenario_list:
            process_scenario_broadcast(scenario_path, save_path, max_hdist_df, num_processes, dl_delay_threshold, ul_delay_threshold, vid_delay_threshold)
