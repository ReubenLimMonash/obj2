...
Desc: Pandas data processing of FANET dataset with multiprocessing.
      ...
      Modified from fanet_data_preprocessing_mitigation_rebroadcasting_19092024.py to use new kind of switch time CSV (from gamma thresholding)
...
def process_scenario_broadcast(scenario_path, save_path, switch_time_path, num_processes, 
    ...
    if not switch_time_df_notna.empty: # If the scenario has no runs where switching occured, no need to process
        ...
        with Pool(num_processes) as pool:
            for result in pool.starmap(process_run, zip(run_number, switch_time, repeat(scenario_path),
                ...
                metric_list.append({"Run": result[0], "Num_Pkts_Reliable_UAV_0": result[3][0], "Num_Pkts_Reliable_UAV_1": result[3][1], "Num_Pkts_Reliable_UAV_2": result[3][2],
                                    "Num_Pkts_Reliable_UAV_3": result[3][3], "Num_Pkts_Reliable_UAV_4": result[3][4], "Num_Pkts_Reliable_UAV_5": result[3][5], "Num_Pkts_Reliable_UAV_6": result[3][6],
                                    "Num_Pkts_Reliable_UAV_7": result[3][7], "Num_Pkts_Reliable_UL": result[4], 
                                    "Num_Broadcast_UAV_0": result[1][0], "Num_Broadcast_UAV_1": result[1][1], "Num_Broadcast_UAV_2": result[1][2], "Num_Broadcast_UAV_3": result[1][3], 
                                    "Num_Broadcast_UAV_4": result[1][4], "Num_Broadcast_UAV_5": result[1][5], "Num_Broadcast_UAV_6": result[1][6], "Num_Broadcast_UAV_7": result[1][7], "Num_Broadcast_UL": result[2],
                                    "UPRR_UAV_0": result[7][0], "UPRR_UAV_1": result[7][1], "UPRR_UAV_2": result[7][2], "UPRR_UAV_3": result[7][3], "UPRR_UAV_4": result[7][4],
                                    "UPRR_UAV_5": result[7][5], "UPRR_UAV_6": result[7][6], "UPRR_UAV_7": result[7][7],
                                    "Reliability_UAV_0": result[5][0], "Reliability_UAV_1": result[5][1], "Reliability_UAV_2": result[5][2], "Reliability_UAV_3": result[5][3],
                                    "Reliability_UAV_4": result[5][4], "Reliability_UAV_5": result[5][5], "Reliability_UAV_6": result[5][6], "Reliability_UAV_7": result[5][7], "Total_Reliability_UL": result[6], 
                                    "Num_Delay_Excd_UAV_0": result[8][0], "Num_Delay_Excd_UAV_1": result[8][1], "Num_Delay_Excd_UAV_2": result[8][2], "Num_Delay_Excd_UAV_3": result[8][3],
                                    "Num_Delay_Excd_UAV_4": result[8][4], "Num_Delay_Excd_UAV_5": result[8][5], "Num_Delay_Excd_UAV_6": result[8][6], "Num_Delay_Excd_UAV_7": result[8][7], 
                                    "UL_Num_Delay_Excd": result[9], "UL_Num_Incr_Rcvd": result[10], "UL_Num_Queue_Overflow": result[11]}) 
    ...
    if len(metric_list) > 0:
        ...
        metric_df = pd.DataFrame(columns=["Run", "Num_Pkts_Reliable_UAV_0", "Num_Pkts_Reliable_UAV_1", "Num_Pkts_Reliable_UAV_2","Num_Pkts_Reliable_UAV_3", 
                                    ...
                                    "Num_Broadcast_UAV_0", "Num_Broadcast_UAV_1", "Num_Broadcast_UAV_2", "Num_Broadcast_UAV_3", 
                                    "Num_Broadcast_UAV_4", "Num_Broadcast_UAV_5", "Num_Broadcast_UAV_6", "Num_Broadcast_UAV_7", "Num_Broadcast_UL",
                                    "UPRR_UAV_0", "UPRR_UAV_1", "UPRR_UAV_2", "UPRR_UAV_3", "UPRR_UAV_4",
                                    "UPRR_UAV_5", "UPRR_UAV_6", "UPRR_UAV_7",
...
def process_run(run_number, switch_time, scenario_path, dl_delay_threshold, ul_delay_threshold):
    ...
    uavs_br_df = br_df_list[1:len(br_df_list)]
    ...
    for i in range(1,len(rx_df_list)):
        ...
        if not uav_rx_df.empty:
            ...
            dl_num_rcvd.append(len(uav_rx_df_reliable)) # For UPRR. We only consider duplicates that are reliably received
            # Drop duplicate packets at Rx DF, keeping the first arrived (to remove duplicates from retransmissions)
            uav_rx_df_reliable = uav_rx_df_reliable.sort_values(["Packet_Name", "RxTime"], ascending=[True, True])
            uav_rx_df_reliable = uav_rx_df_reliable.drop_duplicates(subset='Packet_Name', keep="first")
            # For counting no. of delay excd packets, we consider that any unique packets not reliably received is due to delay excd
            uav_rx_df_uniq = uav_rx_df.sort_values(["Packet_Name", "RxTime"], ascending=[True, True]) 
            uav_rx_df_uniq = uav_rx_df.drop_duplicates(subset='Packet_Name', keep="first")
            ...
            dl_num_delay_excd.append(len(uav_rx_df_uniq) - len(uav_rx_df_reliable)) # We consider that unique packets not in uav_rx_df_reliable are due to delay excd
        else:
    ...
    # Downlink Reliabilities and UPRR
    num_broadcasts_dl = []
    dl_reliability = []
    uprr_dl = []
    ...
    for i in range(len(dl_num_reliable)):
        num_broadcasts_dl.append(len(uavs_br_df[i]))
        # Reliability
        if num_sent_dl > 0:
        ...
        # UPRR
        if dl_num_rcvd[i] > 0:
            uprr_dl.append(dl_num_reliable[i] / dl_num_rcvd[i]) # Useful_Packet_Reception_Ratio_DL
        else:
            uprr_dl.append(np.nan)
    ...
    return (run_number, num_broadcasts_dl, num_broadcasts_ul, dl_num_reliable, ul_num_reliable, dl_reliability, total_reliability_ul, uprr_dl,
...
if __name__ == "__main__":
    ...
    # sim_root_paths = ["/media/research-student/KingstonSSD/FANET_Dataset/DJISpark_Obj3_Retransmission_Datasets/Waypoint_Only_UAV_Interference/uav_scenario_0", 
    #                   "/media/research-student/KingstonSSD/FANET_Dataset/DJISpark_Obj3_Retransmission_Datasets/Waypoint_Only_UAV_Interference/uav_scenario_1", 
    #                   "/media/research-student/KingstonSSD/FANET_Dataset/DJISpark_Obj3_Retransmission_Datasets/Waypoint_Only_UAV_Interference/uav_scenario_2", 
    #                   "/media/research-student/KingstonSSD/FANET_Dataset/DJISpark_Obj3_Retransmission_Datasets/Waypoint_Only_MANET_Interference/manet_scenario_1",
    #                   "/media/research-student/KingstonSSD/FANET_Dataset/DJISpark_Obj3_Retransmission_Datasets/Waypoint_Only_MANET_Interference/manet_scenario_a",
    #                   "/media/research-student/KingstonSSD/FANET_Dataset/DJISpark_Obj3_Retransmission_Datasets/Waypoint_Only_MANET_Interference/manet_scenario_2"]
    # save_paths = ["/media/research-student/KingstonSSD/FANET_Dataset/DJISpark_Obj3_Retransmission_Datasets/Waypoint_Only_UAV_Interference/uav_scenario_0_processed", 
    #                   "/media/research-student/KingstonSSD/FANET_Dataset/DJISpark_Obj3_Retransmission_Datasets/Waypoint_Only_UAV_Interference/uav_scenario_1_processed", 
    #                   "/media/research-student/KingstonSSD/FANET_Dataset/DJISpark_Obj3_Retransmission_Datasets/Waypoint_Only_UAV_Interference/uav_scenario_2_processed", 
    #                   "/media/research-student/KingstonSSD/FANET_Dataset/DJISpark_Obj3_Retransmission_Datasets/Waypoint_Only_MANET_Interference/manet_scenario_1_processed",
    #                   "/media/research-student/KingstonSSD/FANET_Dataset/DJISpark_Obj3_Retransmission_Datasets/Waypoint_Only_MANET_Interference/manet_scenario_a_processed",
    #                   "/media/research-student/KingstonSSD/FANET_Dataset/DJISpark_Obj3_Retransmission_Datasets/Waypoint_Only_MANET_Interference/manet_scenario_2_processed"]
    # switch_time_paths = ["/media/research-student/KingstonSSD/omnet-fanet/obj3_scenario_script/uav_scenario_0/Switch_Details.csv",
    #                      "/media/research-student/KingstonSSD/omnet-fanet/obj3_scenario_script/uav_scenario_1/Switch_Details.csv",
    #                      "/media/research-student/KingstonSSD/omnet-fanet/obj3_scenario_script/uav_scenario_2/Switch_Details.csv",
    #                      "/media/research-student/KingstonSSD/omnet-fanet/obj3_scenario_script/manet_scenario_1/Switch_Details.csv",
    #                      "/media/research-student/KingstonSSD/omnet-fanet/obj3_scenario_script/manet_scenario_a/Switch_Details.csv",
    #                      "/media/research-student/KingstonSSD/omnet-fanet/obj3_scenario_script/manet_scenario_2/Switch_Details.csv"]
    
    sim_root_paths = ["/media/research-student/DataDrive/FANET_Dataset/DJISpark_Obj3_Retransmission_Datasets/G+U_Fixed25_UAV_Interference_new/uav_scenario_0",
                      "/media/research-student/DataDrive/FANET_Dataset/DJISpark_Obj3_Retransmission_Datasets/G+U_Fixed25_UAV_Interference_new/uav_scenario_1",
                      "/media/research-student/DataDrive/FANET_Dataset/DJISpark_Obj3_Retransmission_Datasets/G+U_Fixed25_UAV_Interference_new/uav_scenario_2",
                      "/media/research-student/DataDrive/FANET_Dataset/DJISpark_Obj3_Retransmission_Datasets/G+U_Fixed25_MANET_Interference_new/manet_scenario_1",
                      "/media/research-student/DataDrive/FANET_Dataset/DJISpark_Obj3_Retransmission_Datasets/G+U_Fixed25_MANET_Interference_new/manet_scenario_a",
                      "/media/research-student/DataDrive/FANET_Dataset/DJISpark_Obj3_Retransmission_Datasets/G+U_Fixed25_MANET_Interference_new/manet_scenario_2"]
    save_paths = ["/media/research-student/DataDrive/FANET_Dataset/DJISpark_Obj3_Retransmission_Datasets/G+U_Fixed25_UAV_Interference_new/uav_scenario_0_processed",
                      "/media/research-student/DataDrive/FANET_Dataset/DJISpark_Obj3_Retransmission_Datasets/G+U_Fixed25_UAV_Interference_new/uav_scenario_1_processed",
                      "/media/research-student/DataDrive/FANET_Dataset/DJISpark_Obj3_Retransmission_Datasets/G+U_Fixed25_UAV_Interference_new/uav_scenario_2_processed",
                      "/media/research-student/DataDrive/FANET_Dataset/DJISpark_Obj3_Retransmission_Datasets/G+U_Fixed25_MANET_Interference_new/manet_scenario_1_processed",
                      "/media/research-student/DataDrive/FANET_Dataset/DJISpark_Obj3_Retransmission_Datasets/G+U_Fixed25_MANET_Interference_new/manet_scenario_a_processed",
                      "/media/research-student/DataDrive/FANET_Dataset/DJISpark_Obj3_Retransmission_Datasets/G+U_Fixed25_MANET_Interference_new/manet_scenario_2_processed"]
