...
if __name__ == "__main__":
    ...
    SAVE_PATH = "/home/research-student/omnet-fanet/data-processing-scripts/journal_3_scripts/throughput_failure_detection_overall_results_500_runs_manet0.csv"
    CONF_MAT_PATH = "/home/research-student/omnet-fanet/data-processing-scripts/journal_3_scripts/throughput_failure_detection_conf_matrix_500_runs_manet0.csv"
    YOUDEN_PATH = "/home/research-student/omnet-fanet/data-processing-scripts/journal_3_scripts/roc_auc_analysis_manet_0.csv"
    ...
    youden_df_temp = youden_df.loc[(youden_df["Scenario"]=="manet_scenario_0_{}_processed.csv") & (youden_df["Metric"]=="Throughput_Threshold")]
    assert not youden_df_temp.empty, "Youden Threshold for this scenario not found: {}".format("manet_scenario_0_{}_processed.csv")
