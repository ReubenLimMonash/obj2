...
Desc: Pandas data processing of FANET dataset with multiprocessing.
      ...
      Modified to handle files for each scenarios being in separate folders. And removed measured sinr recording as it has been removed
'''
...
if __name__ == "__main__":
    ...
    '''
    sim_root_path = "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/max_hdist_batch_2"
    save_path = "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/max_hdist_batch_2_processed"
    num_workers = 32
