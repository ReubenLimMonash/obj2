...
def process_scenario_broadcast(scenario_path, save_path, switch_time_path, num_processes, 
    ...
    if len(metric_list) > 0:
        ...
        metric_df = pd.DataFrame(columns=['Run','Num_Pkts_Reliable_DL','Num_Pkts_Reliable_UL','Useful_Packet_Reception_Ratio_DL','Total_Reliability_DL','Total_Reliability_UL',
