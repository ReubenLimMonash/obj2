...
# Modified from: fanet_num_reliable_vs_measured_reliability.py
...
if __name__ == "__main__":
    ...
    SAVE_CORRELATION_SPEARMAN = "/home/research-student/reuben_ws/omnet-fanet/results_new_Mar25/Num_Reliability_Spearman_500_runs.csv"
    ...
    for dataset in DATASET_PATH:
        ...
        uav0_groups = uav_0_num_reliable_df.groupby(['USI', 'Bit_Rate', 'UAV_Height', 'UAV_Speed'])
        uav1_groups = uav_1_num_reliable_df.groupby(['USI', 'Bit_Rate', 'UAV_Height', 'UAV_Speed'])
        uav2_groups = uav_2_num_reliable_df.groupby(['USI', 'Bit_Rate', 'UAV_Height', 'UAV_Speed'])
        uav3_groups = uav_3_num_reliable_df.groupby(['USI', 'Bit_Rate', 'UAV_Height', 'UAV_Speed'])
        uav4_groups = uav_4_num_reliable_df.groupby(['USI', 'Bit_Rate', 'UAV_Height', 'UAV_Speed'])
        uav5_groups = uav_5_num_reliable_df.groupby(['USI', 'Bit_Rate', 'UAV_Height', 'UAV_Speed'])
        uav6_groups = uav_6_num_reliable_df.groupby(['USI', 'Bit_Rate', 'UAV_Height', 'UAV_Speed'])
        uav7_groups = uav_7_num_reliable_df.groupby(['USI', 'Bit_Rate', 'UAV_Height', 'UAV_Speed'])
        ...
        for group in tqdm(set(gcs_groups.groups.keys())):
            ...
            if UNIQUE:
                gcs_group_df = gcs_group_df.drop_duplicates(subset=["Num_Reliable", "Measured_Reliability_1"])
                uav0_group_df = uav0_group_df.drop_duplicates(subset=["Num_Reliable", "Measured_Reliability_1"])
                uav1_group_df = uav1_group_df.drop_duplicates(subset=["Num_Reliable", "Measured_Reliability_1"])
                uav2_group_df = uav2_group_df.drop_duplicates(subset=["Num_Reliable", "Measured_Reliability_1"])
                uav3_group_df = uav3_group_df.drop_duplicates(subset=["Num_Reliable", "Measured_Reliability_1"])
                uav4_group_df = uav4_group_df.drop_duplicates(subset=["Num_Reliable", "Measured_Reliability_1"])
                uav5_group_df = uav5_group_df.drop_duplicates(subset=["Num_Reliable", "Measured_Reliability_1"])
                uav6_group_df = uav6_group_df.drop_duplicates(subset=["Num_Reliable", "Measured_Reliability_1"])
                uav7_group_df = uav7_group_df.drop_duplicates(subset=["Num_Reliable", "Measured_Reliability_1"])
            
            # Spearman Rho
            spearmanr_gcs = stats.spearmanr(gcs_group_df["Num_Reliable"].values, gcs_group_df["Measured_Reliability_1"].values)
            spearmanr_uav_0 = stats.spearmanr(uav0_group_df["Num_Reliable"].values, uav0_group_df["Measured_Reliability_1"].values)
            spearmanr_uav_1 = stats.spearmanr(uav1_group_df["Num_Reliable"].values, uav1_group_df["Measured_Reliability_1"].values)
            spearmanr_uav_2 = stats.spearmanr(uav2_group_df["Num_Reliable"].values, uav2_group_df["Measured_Reliability_1"].values)
            spearmanr_uav_3 = stats.spearmanr(uav3_group_df["Num_Reliable"].values, uav3_group_df["Measured_Reliability_1"].values)
            spearmanr_uav_4 = stats.spearmanr(uav4_group_df["Num_Reliable"].values, uav4_group_df["Measured_Reliability_1"].values)
            spearmanr_uav_5 = stats.spearmanr(uav5_group_df["Num_Reliable"].values, uav5_group_df["Measured_Reliability_1"].values)
            spearmanr_uav_6 = stats.spearmanr(uav6_group_df["Num_Reliable"].values, uav6_group_df["Measured_Reliability_1"].values)
            spearmanr_uav_7 = stats.spearmanr(uav7_group_df["Num_Reliable"].values, uav7_group_df["Measured_Reliability_1"].values)
