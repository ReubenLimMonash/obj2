...
Desc: Pandas data processing of FANET dataset with multiprocessing.
      ...
      Purpose: For processing throughput dataset (manual control) for training/testing OCSVM/LOF models.
'''
...
def process_scenario_v4(scenario_path, save_path, num_processes, 
    ...
    with Pool(num_processes) as pool:
        pool.starmap(process_run, zip(run_number, repeat(run_file_path), repeat(save_path), repeat(scenario), repeat(height), repeat(uav_sending_interval), repeat(mcs_index), repeat(uav_speed),
...
if __name__ == "__main__":
    ...
    '''
    sim_root_paths = ["/home/wlau0003/Reuben_ws/FANET_Dataset/DJISpark_Measured_Throughput_100000_Samples/data_ocsvm_train"]
    save_paths = ["/home/wlau0003/Reuben_ws/FANET_Dataset/DJISpark_Measured_Throughput_100000_Samples/data_ocsvm_train_processed"]
