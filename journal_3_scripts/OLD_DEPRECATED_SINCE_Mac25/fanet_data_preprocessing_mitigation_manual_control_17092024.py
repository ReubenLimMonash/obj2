...
def process_run(run_number, switch_time, scenario_path, dl_delay_threshold, ul_delay_threshold, vid_delay_threshold=0):
    ...
    gcs_pd_df = gcs_pd_df.loc[gcs_pd_df["TxTime"] >= switch_time]
    ...
    for i in range(1,len(rx_df_list)):
        ...
        if not uav_rx_df.empty:
            num_reliable, num_delay_excd, num_incr_rcvd, num_queue_overflow = count_packet_states(uav_rx_df, gcs_pd_df, dl_delay_threshold)
...
if __name__ == "__main__":
    ...
    sim_root_paths = ["/home/rlim0005/FANET_Dataset/DJISpark_Obj3_Retransmission_Datasets/FP_Based_UAV_Interference/uav_senario_0"]
    save_paths = ["/home/rlim0005/FANET_Dataset/DJISpark_Obj3_Retransmission_Datasets/FP_Based_UAV_Interference/uav_senario_0_processed"]
    switch_time_paths = ["/home/rlim0005/FANET_Dataset/DJISpark_Obj3_Retransmission_Datasets/FP_Based_UAV_Interference/uav_senario_0_switch_time.csv"]
