...
def test_no_int_run(run_num, scenario, reliability_th, dl_num_reliable_th, ul_num_reliable_th, vid_num_reliable_th):
    ...
    # For no interference case, filter throughput samples where measured_num_reliable < reliability threshold
    # Downlink
    dl_num_reliable_df_reliable = dl_num_reliable_df.loc[dl_num_reliable_df["Measured_Reliability"] >= reliability_th]
    # if len(dl_num_reliable_df_reliable) < len(dl_num_reliable_df):
    #     print("Samples with measured reliability < threshold detected in scenario: {}".format(scenario_name))
    #     print("Num samples with measured reliability < threshold: {}".format(len(dl_num_reliable_df) - len(dl_num_reliable_df_reliable)))
    dl_y_pred_outlier = dl_num_reliable_df_reliable["Num_Reliable"] < dl_num_reliable_th 
    dl_num_outlier = dl_y_pred_outlier.sum() # This will sum the number of True elements
    dl_num_samples = len(dl_num_reliable_df_reliable)
    ...
    # Uplink
    ul_num_reliable_df_reliable = ul_num_reliable_df.loc[ul_num_reliable_df["Measured_Reliability"] >= reliability_th]
    # if len(ul_num_reliable_df_reliable) < len(ul_num_reliable_df):
    #     print("Samples with measured reliability < threshold detected in scenario: {}".format(scenario_name))
    ul_y_pred_outlier = ul_num_reliable_df_reliable["Num_Reliable"] < ul_num_reliable_th 
    ul_num_outlier = ul_y_pred_outlier.sum() # This will sum the number of True elements
    ul_num_samples = len(ul_num_reliable_df_reliable)
    ...
    # Video
    vid_num_reliable_df_reliable = vid_num_reliable_df.loc[vid_num_reliable_df["Measured_Reliability"] >= reliability_th]
    # if len(vid_num_reliable_df_reliable) < len(vid_num_reliable_df):
    #     print("Samples with measured reliability < threshold detected in scenario: {}".format(scenario_name))
    vid_y_pred_outlier = vid_num_reliable_df_reliable["Num_Reliable"] < vid_num_reliable_th 
    vid_num_outlier = vid_y_pred_outlier.sum() # This will sum the number of True elements
    vid_num_samples = len(vid_num_reliable_df_reliable)
...
def test_int_run(run_num, scenario, reliability_th, dl_num_reliable_th, ul_num_reliable_th, vid_num_reliable_th):
    ...
    # For no interference case, filter throughput samples where measured_num_reliable < reliability threshold
    # Downlink
    dl_y_pred_outlier = dl_num_reliable_df["Num_Reliable"] < dl_num_reliable_th 
    dl_num_outlier = dl_y_pred_outlier.sum() # This will sum the number of True elements
    dl_num_samples = len(dl_num_reliable_df)
    ...
    # Uplink
    ul_y_pred_outlier = ul_num_reliable_df["Num_Reliable"] < ul_num_reliable_th 
    ul_num_outlier = ul_y_pred_outlier.sum() # This will sum the number of True elements
    ul_num_samples = len(ul_num_reliable_df)
    ...
    # Video
    vid_y_pred_outlier = vid_num_reliable_df["Num_Reliable"] < vid_num_reliable_th 
    vid_num_outlier = vid_y_pred_outlier.sum() # This will sum the number of True elements
    vid_num_samples = len(vid_num_reliable_df)
...
if __name__ == "__main__":
    ...
    ''' Define Paths Here'''
    # MIN_NR_FILE = "/home/research-student/omnet-fanet/data-processing-scripts/journal_3_scripts/data_manual_num_reliable_min_max_16102024.csv"
    ...
    SAVE_PATH = "/home/research-student/omnet-fanet/data-processing-scripts/journal_3_scripts/num_reliable_failure_detection_results_shifted_2"
    SAVE_FILE_NO_INT = "num_reliable_no_int_test_results.csv"
    SAVE_FILE_NO_INT_FP = "num_reliable_no_int_fp.csv"
    SAVE_FILES_INT = ["num_reliable_uav_interference_scenario_0_results.csv", "num_reliable_uav_interference_scenario_1_results.csv", "num_reliable_uav_interference_scenario_2_results.csv", 
                      "num_reliable_manet_interference_scenario_0_results.csv", "num_reliable_manet_interference_scenario_1_results.csv", "num_reliable_manet_interference_scenario_2_results.csv"]
    SAVE_FILES_CONF_MAT = ["num_reliable_uav_interference_scenario_0_conf_mat.csv", "num_reliable_uav_interference_scenario_1_conf_mat.csv", "num_reliable_uav_interference_scenario_2_conf_mat.csv", 
                      "num_reliable_manet_interference_scenario_0_conf_mat.csv", "num_reliable_manet_interference_scenario_1_conf_mat.csv", "num_reliable_manet_interference_scenario_2_conf_mat.csv"]
    SAVE_FILES_INT_FN = ["num_reliable_uav_interference_scenario_0_fn.csv", "num_reliable_uav_interference_scenario_1_fn.csv", "num_reliable_uav_interference_scenario_2_fn.csv", 
                         "num_reliable_manet_interference_scenario_0_fn.csv", "num_reliable_manet_interference_scenario_1_fn.csv", "num_reliable_manet_interference_scenario_2_fn.csv"]
    SAVE_FILES_INT_FP = ["num_reliable_uav_interference_scenario_0_fp.csv", "num_reliable_uav_interference_scenario_1_fp.csv", "num_reliable_uav_interference_scenario_2_fp.csv", 
                         "num_reliable_manet_interference_scenario_0_fp.csv", "num_reliable_manet_interference_scenario_1_fp.csv", "num_reliable_manet_interference_scenario_2_fp.csv"]
    RELIABILITY_TH = 0.999 # Threshold to evaluate interference scenarios
    NUM_PROCS = 32
    # Create dataframe of n_r thresholds
    ...
    #         continue
    #     # Get the min throughput of each link for the corresponding USI and scale it
    ...
    #                                                         repeat(dl_num_reliable_th), repeat(ul_num_reliable_th), repeat(vid_num_reliable_th))):
    ...
    #     overall_percent_int_detected = len(false_pos_df) / len(uplink_num_reliable_files)

    #     # Record scenario results
    #     scenario_results.append({"Scenario": scenario_name, "Num_Runs": len(uplink_num_reliable_files), "Overall_Percent_Int_Detected": overall_percent_int_detected,
    ...
    for datasets in DATASET_INT_PATHS:
        ...
        for scenario in tqdm(scenarios_int):
            ...
            with Pool(NUM_PROCS) as pool:
                for result in pool.starmap(test_int_run, zip(run_nums, repeat(scenario), repeat(RELIABILITY_TH), repeat(dl_num_reliable_th), repeat(ul_num_reliable_th), repeat(vid_num_reliable_th))):
                    dl_run_results.append(result[0])
                    ul_run_results.append(result[1])
                    vid_run_results.append(result[2])
            ...
            # Record scenario results
            scenario_results.append({"Scenario": scenario_name, "Num_Runs": len(uplink_num_reliable_files), "Overall_Accuracy": overall_accuracy, "Overall_Percent_Int_Detected": overall_percent_int_detected,
            ...
            conf_mat_results.append({"Scenario": scenario_name, "Num_Runs": len(uplink_num_reliable_files), 
