...
def process_scenario_v4(scenario_path, save_path, dl_stride, ul_stride, dl_slot_size, ul_slot_size, dl_delay_threshold, ul_delay_threshold):
    '''
...
if __name__ == "__main__":
    ...
    '''
    sim_root_path = "/media/research-student/One Touch/FANET_Dataset/DJISpark_ReBroadcast_Protocols_Manet_Interference/throughput_based_CT-3_version-3"
    save_path = "/media/research-student/One Touch/FANET_Dataset/DJISpark_ReBroadcast_Protocols_Manet_Interference/throughput_based_CT-3_version-3_processed"
    # sim_root_path = "/media/research-student/One Touch/FANET_Dataset/DJISpark_ReBroadcast_Protocols_Interference/dvcast_prob_CT-3"
    # save_path = "/media/research-student/One Touch/FANET_Dataset/DJISpark_ReBroadcast_Protocols_Interference/dvcast_prob_CT-3_processed"
    ...
    with Pool(10) as pool:
        pool.starmap(process_scenario_v4, zip(scenario_list, repeat(save_path), repeat(dl_stride), repeat(ul_stride), repeat(dl_slot_size), repeat(ul_slot_size), repeat(dl_delay_threshold), repeat(ul_delay_threshold)))
