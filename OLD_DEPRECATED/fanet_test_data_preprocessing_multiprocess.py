...
def process_dropped_packets_v6(tx_df, rx_df, pd_df_list):
    '''
    Date: 2/2/2023
...
def process_scenario_v2(scenario, sim_root_path, delay_threshold, save_path):
    print(scenario)
    ...
    dl_df = process_dropped_packets_v6(gcs_tx_df, uavs_rx_df, pd_df_list)
    if dl_df is not None:
        ...
        dl_df["Mean_Sending_Interval"] = sending_interval
    ...
    ul_df = process_dropped_packets_v6(uavs_tx_df, gcs_rx_df, pd_df_list)
    if ul_df is not None:
        ...
        ul_df["Mean_Sending_Interval"] = sending_interval
...
def process_sim_data_v2(sim_root_path, delay_threshold, save_path):
    ...
    process_scenario_v2(scenario_list[0],sim_root_path, delay_threshold, save_path)
    return 

if __name__ == "__main__":
    sim_root_path = "/home/research-student/omnetpp_sim_results/Test_Dataset_BPSK_6-5Mbps/GM_Mobility"
    save_path = "/home/research-student/omnetpp_sim_results/Test_Dataset_BPSK_6-5Mbps/GM_Mobility_processed"
