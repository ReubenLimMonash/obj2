...
df_bpsk = pd.read_csv("/media/research-student/One Touch/FANET_Dataset/Dataset_NP10000_MultiModulation_Hovering_{}/BPSK_processed_throughput_{}.csv".format(video_novideo, link_type),
...
df_qpsk = pd.read_csv("/media/research-student/One Touch/FANET_Dataset/Dataset_NP10000_MultiModulation_Hovering_{}/QPSK_processed_throughput_{}.csv".format(video_novideo, link_type),
                    usecols = ["Mean_SINR", "Std_Dev_SINR", "UAV_Sending_Interval", "Throughput"],
                    dtype=df_dtypes)
...
df_qam16 = pd.read_csv("/media/research-student/One Touch/FANET_Dataset/Dataset_NP10000_MultiModulation_Hovering_{}/QAM16_processed_throughput_{}.csv".format(video_novideo, link_type),
                    usecols = ["Mean_SINR", "Std_Dev_SINR", "UAV_Sending_Interval", "Throughput"],
                    dtype=df_dtypes)
...
df_qam64 = pd.read_csv("/media/research-student/One Touch/FANET_Dataset/Dataset_NP10000_MultiModulation_Hovering_{}/QAM64_processed_throughput_{}.csv".format(video_novideo, link_type),
                    usecols = ["Mean_SINR", "Std_Dev_SINR", "UAV_Sending_Interval", "Throughput"],
                    dtype=df_dtypes)
