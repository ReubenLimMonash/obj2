...
def process_scenario_v4(scenario_path, save_path, 
    ...
    run_numbers = [run.split('/')[-1].split("_")[0].split("-")[-1] for run in runs]
    for run_number in run_numbers:
        run_file_path = os.path.join(scenario_path, "Run-{}_*.csv")
        run_files = glob.glob(run_file_path.format(run_number)) # Get list of csv files belonging to this scenario
        ...
        metric_list.append({"Run": run_number,"Total_Reliability_DL": dl_reliability, "Total_Reliability_UL": ul_reliability, "Total_Reliability_Vid": vid_reliability})
...
if __name__ == "__main__":
    ...
    '''
    sim_root_path = "/home/research-student/FANET_Dataset/DJISpark_Measured_Throughput_10000Samples/using_sim_reliability/data_ocsvm_train"
    save_path = "/home/research-student/FANET_Dataset/DJISpark_Measured_Throughput_10000Samples/using_sim_reliability/data_ocsvm_train_processed"
    # sim_root_path = "/home/wlau0003/Reuben_ws/FANET_Dataset/DJISpark_Measured_Throughput_10000Samples/ocsvm_test_dataset/data_manet_interference_singlerun"
    # save_path = "/home/wlau0003/Reuben_ws/FANET_Dataset/DJISpark_Measured_Throughput_10000Samples/ocsvm_test_dataset/data_manet_interference_singlerun_processed"
    ...
    with Pool(num_processes) as pool:
        pool.starmap(process_scenario_v4, zip(scenario_list, repeat(save_path), 
