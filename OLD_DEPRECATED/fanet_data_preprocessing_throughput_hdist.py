...
if __name__ == "__main__":
    df_file ="/media/research-student/One Touch/FANET_Dataset/Dataset_NP10000_MultiModulation_Hovering_NoVideo/Test/Test_Dataset_1_10000_processed/NumMember-7_InterUAVDistance-5_Height-75_Distance-5_Modulation-QAM-64_UAVSendingInterval-1000_downlink.csv"
    ...
    print(end-start)
    # df_processed.to_csv("/media/research-student/One Touch/FANET_Dataset/Dataset_NP10000_MultiModulation_Hovering_NoVideo/Test/NumMember-7_InterUAVDistance-5_Height-75_Distance-5_Modulation-BPSK_UAVSendingInterval-10_uplink_throughput.csv")