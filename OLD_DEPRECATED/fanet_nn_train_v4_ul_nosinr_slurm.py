...
# Training params
EPOCHS = 5
# checkpoint_filepath = '/home/rlim0005/nn_checkpoints/nn_v4_multimodulation_video_nosinr_ul'
checkpoint_filepath = '/home/wlau0003/Reuben_ws/nn_checkpoints/nn_v4_multimodulation_video_nosinr_ul'
...
ul_df_bpsk = pd.read_csv("/home/wlau0003/Reuben_ws/FANET_Dataset/Dataset_NP10000_MultiModulation_Hovering_Video/BPSK_processed_train_uplink.csv",
...
ul_df_qpsk = pd.read_csv("/home/wlau0003/Reuben_ws/FANET_Dataset/Dataset_NP10000_MultiModulation_Hovering_Video/QPSK_processed_train_uplink.csv",
                    usecols = ["Mean_SINR", "Std_Dev_SINR", "Num_Members", "UAV_Sending_Interval", "Packet_State", "Delay", "U2G_H_Dist", "Height"],
                    dtype=df_dtypes)
ul_df_qpsk["Modulation"] = 0.3333

ul_df_qam16 = pd.read_csv("/home/wlau0003/Reuben_ws/FANET_Dataset/Dataset_NP10000_MultiModulation_Hovering_Video/QAM16_processed_train_uplink.csv",
                    usecols = ["Mean_SINR", "Std_Dev_SINR", "Num_Members", "UAV_Sending_Interval", "Packet_State", "Delay", "U2G_H_Dist", "Height"],
                    dtype=df_dtypes)
ul_df_qam16["Modulation"] = -0.3333

ul_df_qam64 = pd.read_csv("/home/wlau0003/Reuben_ws/FANET_Dataset/Dataset_NP10000_MultiModulation_Hovering_Video/QAM64_processed_train_uplink.csv",
                    usecols = ["Mean_SINR", "Std_Dev_SINR", "Num_Members", "UAV_Sending_Interval", "Packet_State", "Delay", "U2G_H_Dist", "Height"],
                    dtype=df_dtypes)
...
# Load test dataset ==========================================================================================================================
ul_df_bpsk = pd.read_csv("/home/wlau0003/Reuben_ws/FANET_Dataset/Dataset_NP10000_MultiModulation_Hovering_Video/BPSK_processed_holdout_uplink.csv",
                    usecols = ["Mean_SINR", "Std_Dev_SINR", "Num_Members", "UAV_Sending_Interval", "Packet_State", "Delay", "U2G_H_Dist", "Height"],
                    dtype=df_dtypes)
ul_df_bpsk["Modulation"] = 1

ul_df_qpsk = pd.read_csv("/home/wlau0003/Reuben_ws/FANET_Dataset/Dataset_NP10000_MultiModulation_Hovering_Video/QPSK_processed_holdout_uplink.csv",
                    usecols = ["Mean_SINR", "Std_Dev_SINR", "Num_Members", "UAV_Sending_Interval", "Packet_State", "Delay", "U2G_H_Dist", "Height"],
                    dtype=df_dtypes)
ul_df_qpsk["Modulation"] = 0.3333

ul_df_qam16 = pd.read_csv("/home/wlau0003/Reuben_ws/FANET_Dataset/Dataset_NP10000_MultiModulation_Hovering_Video/QAM16_processed_holdout_uplink.csv",
                    usecols = ["Mean_SINR", "Std_Dev_SINR", "Num_Members", "UAV_Sending_Interval", "Packet_State", "Delay", "U2G_H_Dist", "Height"],
                    dtype=df_dtypes)
ul_df_qam16["Modulation"] = -0.3333

ul_df_qam64 = pd.read_csv("/home/wlau0003/Reuben_ws/FANET_Dataset/Dataset_NP10000_MultiModulation_Hovering_Video/QAM64_processed_holdout_uplink.csv",
                    usecols = ["Mean_SINR", "Std_Dev_SINR", "Num_Members", "UAV_Sending_Interval", "Packet_State", "Delay", "U2G_H_Dist", "Height"],
                    dtype=df_dtypes)
ul_df_qam64["Modulation"] = -1
...
model_checkpoint_callback = keras.callbacks.ModelCheckpoint(
    ...
    # filepath=os.path.join(checkpoint_filepath,"model.005-{val_loss:.4f}.h5"),
...
with open(os.path.join(checkpoint_filepath, 'trainHistoryDict_13062023'), 'wb') as file_pi:
