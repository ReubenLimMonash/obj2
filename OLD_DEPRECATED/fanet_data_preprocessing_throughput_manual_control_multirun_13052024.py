...
def process_scenario_v4(scenario_path, save_path, max_hdist_df, num_processes, 
    ...
    # NOTE: Yes, we mean to filter by max hdist for waypoint mode, even though it is operating in manual control
    ...
    with Pool(num_processes) as pool:
        for result in pool.starmap(process_run, zip(run_number, repeat(run_file_path), repeat(save_path), repeat(scenario), repeat(height), repeat(uav_sending_interval), repeat(mcs_index), repeat(uav_speed), repeat(max_hdist), 
            ...
            metric_list.append({"Run": result[0], "Total_Reliability_DL": result[1], "Total_Reliability_UL": result[2], "Total_Reliability_VID": result[3]})
...
def process_run(run_number, file_path, save_path, scenario, height, uav_sending_interval, mcs_index, uav_speed, max_hdist, 
                dl_stride, ul_stride, dl_slot_size, ul_slot_size, dl_delay_threshold, ul_delay_threshold,
                vid_stride=1, vid_slot_size=1, vid_delay_threshold=0):
    '''
    ...
    gcs_pd_df = gcs_pd_df.loc[gcs_pd_df["TxTime"] <= max_time]
    ...
    for i in range(1,len(rx_df_list)):
        ...
        if not uav_rx_df.empty:
            ...
            uav_rx_df = uav_rx_df.loc[(uav_rx_df["Delay"] <= dl_delay_threshold)] # Get reliable packets
            num_dl_reliable += len(uav_rx_df)
            ...
            uav_throughput_df = process_throughput_sliding_window_time_v2(uav_rx_df, pkts_pd_df, dl_slot_size, dl_stride, max_time, uav_speed)
    ...
    gcs_rx_df = gcs_rx_df.loc[(gcs_rx_df["Delay"] <= ul_delay_threshold)] # Get reliable packets
    if not gcs_rx_df.empty:
        max_time = np.nanmax([uavs_tx_df["TxTime"].max(), gcs_rx_df["RxTime"].max(), uavs_pd_df["RxTime"].max()])
        ul_throughput_df = process_throughput_sliding_window_time_v2(gcs_rx_df, uavs_pd_df, ul_slot_size, ul_stride, max_time, uav_speed)
    ...
    if vid_delay_threshold > 0:
        ...
        video_rx_df = video_rx_df.loc[(video_rx_df["Delay"] <= vid_delay_threshold)] # Get reliable packets
        if not video_rx_df.empty:
            max_time = np.nanmax([video_tx_df["TxTime"].max(), video_rx_df["RxTime"].max(), video_pd_df["RxTime"].max()])
            vid_throughput_df = process_throughput_sliding_window_time_v2(video_rx_df, video_pd_df, vid_slot_size, vid_stride, max_time, uav_speed)
        ...
        num_vid_reliable = len(video_rx_df)
        num_vid_sent = len(video_tx_df)
        vid_reliability = num_vid_reliable / num_vid_sent
    else:
        vid_reliability = np.nan
        
    return (run_number, dl_reliability, ul_reliability, vid_reliability)
...
if __name__ == "__main__":
    ...
    # sim_root_path = "/home/wlau0003/Reuben_ws/FANET_Dataset/DJISpark_Manual_Control_MANET_Interference/data"
    # save_path = "/home/wlau0003/Reuben_ws/FANET_Dataset/DJISpark_Manual_Control_MANET_Interference/data_processed"
    sim_root_paths = ["/home/rlim0005/FANET_Dataset/DJISpark_Manual_Control_UAV_Interference/case1",
                      "/home/rlim0005/FANET_Dataset/DJISpark_Manual_Control_UAV_Interference/case2",
                      "/home/rlim0005/FANET_Dataset/DJISpark_Manual_Control_UAV_Interference/case3",
                      "/home/rlim0005/FANET_Dataset/DJISpark_Manual_Control_UAV_Interference/case4",
                      "/home/rlim0005/FANET_Dataset/DJISpark_Manual_Control_UAV_Interference/case5",
                      "/home/rlim0005/FANET_Dataset/DJISpark_Manual_Control_UAV_Interference/case6",
                      "/home/rlim0005/FANET_Dataset/DJISpark_Manual_Control_UAV_Interference/case7",
                      "/home/rlim0005/FANET_Dataset/DJISpark_Manual_Control_UAV_Interference/case8",
                      "/home/rlim0005/FANET_Dataset/DJISpark_Manual_Control_UAV_Interference/case9",
                      "/home/rlim0005/FANET_Dataset/DJISpark_Manual_Control_UAV_Interference/case10"]
    save_paths = ["/home/rlim0005/FANET_Dataset/DJISpark_Manual_Control_UAV_Interference/case1_processed",
                      "/home/rlim0005/FANET_Dataset/DJISpark_Manual_Control_UAV_Interference/case2_processed",
                      "/home/rlim0005/FANET_Dataset/DJISpark_Manual_Control_UAV_Interference/case3_processed",
                      "/home/rlim0005/FANET_Dataset/DJISpark_Manual_Control_UAV_Interference/case4_processed",
                      "/home/rlim0005/FANET_Dataset/DJISpark_Manual_Control_UAV_Interference/case5_processed",
                      "/home/rlim0005/FANET_Dataset/DJISpark_Manual_Control_UAV_Interference/case6_processed",
                      "/home/rlim0005/FANET_Dataset/DJISpark_Manual_Control_UAV_Interference/case7_processed",
                      "/home/rlim0005/FANET_Dataset/DJISpark_Manual_Control_UAV_Interference/case8_processed",
                      "/home/rlim0005/FANET_Dataset/DJISpark_Manual_Control_UAV_Interference/case9_processed",
                      "/home/rlim0005/FANET_Dataset/DJISpark_Manual_Control_UAV_Interference/case10_processed"]
    ...
    for sim_root_path, save_path in zip(sim_root_paths, save_paths):
        ...
        for scenario_path in scenario_list:
            process_scenario_v4(scenario_path, save_path, max_hdist_df, num_processes, 
                                dl_stride, ul_stride, dl_slot_size, ul_slot_size, dl_delay_threshold, ul_delay_threshold, 
