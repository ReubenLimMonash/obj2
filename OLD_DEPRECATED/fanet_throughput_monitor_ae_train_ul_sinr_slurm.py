'''
Date: 26/06/2023
Desc: To train an autoencoder as a feature extractor for throughput monitoring
...
ul_df_bpsk = pd.read_csv("/media/research-student/One Touch/FANET_Dataset/Dataset_NP10000_MultiModulation_Hovering_NoVideo/BPSK_processed_throughput_uplink.csv",
...
ul_df_qpsk = pd.read_csv("/media/research-student/One Touch/FANET_Dataset/Dataset_NP10000_MultiModulation_Hovering_NoVideo/QPSK_processed_throughput_uplink.csv",
                    usecols = ["Mean_SINR", "Std_Dev_SINR", "UAV_Sending_Interval", "Throughput"],
                    dtype=df_dtypes)
...
ul_df_qam16 = pd.read_csv("/media/research-student/One Touch/FANET_Dataset/Dataset_NP10000_MultiModulation_Hovering_NoVideo/QAM16_processed_throughput_uplink.csv",
                    usecols = ["Mean_SINR", "Std_Dev_SINR", "UAV_Sending_Interval", "Throughput"],
                    dtype=df_dtypes)
...
ul_df_qam64 = pd.read_csv("/media/research-student/One Touch/FANET_Dataset/Dataset_NP10000_MultiModulation_Hovering_NoVideo/QAM64_processed_throughput_uplink.csv",
                    usecols = ["Mean_SINR", "Std_Dev_SINR", "UAV_Sending_Interval", "Throughput"],
                    dtype=df_dtypes)
...
recon_in = Dense(5, activation='linear', name='reconstructed_inputs')(decoder)
...
history = model.fit(X_train, X_train, epochs=EPOCHS, callbacks=[model_checkpoint_callback], validation_data=(X_train, X_train))
