...
Desc: Pandas data processing of FANET dataset with multiprocessing.
      ...
      Modified to process test dataset, where the mobility assumption is different
      Compared to main dataset processing, we can't use uav speed to estimate location of uavs
'''
...
def process_dropped_packets_v7(tx_df, rx_df, pd_df_list, mean_sending_interval=40, NP=10000):
    ...
    Update: Changed to work with Categorical Packet_Type data instead of str type Packet_Name. This has proven to be much faster
    ...
    # NOTE: Added the following for processing test dataset
    # rx_df["U2G_Distance"].fillna(method="ffill", inplace=True) 
...
if __name__ == "__main__":
    sim_root_path = "/media/research-student/One Touch/FANET Datasets/Test_Dataset_NP10000_BPSK_6-5Mbps"
    save_path = "/media/research-student/One Touch/FANET Datasets/Test_Dataset_NP10000_BPSK_6-5Mbps_processed/"
    # sim_root_path = "/media/research-student/One Touch/FANET Datasets/Test2"
    # save_path = "/media/research-student/One Touch/FANET Datasets/Test2_processed/"
