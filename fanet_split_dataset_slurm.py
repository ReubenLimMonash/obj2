...
dl_df_part_1, dl_df_part_2 = train_test_split(dl_df, test_size=0.5, random_state=50, shuffle=False)

# Save to pickle
dl_df_part_1.to_pickle("/home/rlim0005/FANET_Dataset/Dataset_NP10000_MultiModulation_Hovering_NoVideo/downlink_df_part_1.pkl")
dl_df_part_2.to_pickle("/home/rlim0005/FANET_Dataset/Dataset_NP10000_MultiModulation_Hovering_NoVideo/downlink_df_part_2.pkl")
