...
Modified: Train for experiment 1 only, using data with horizontal distance >= 150m
'''
...
checkpoint_filepath = '/home/rlim0005/nn_checkpoints/nn_v2_Exp1_partial'
...
# Use only data with horizontal distance above 150m
dl_df = dl_df.loc[(dl_df["U2G_H_Dist"] >= 150)].copy()
