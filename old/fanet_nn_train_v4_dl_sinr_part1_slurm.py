...
checkpoint_filepath = '/home/rlim0005/nn_checkpoints/nn_v4_multimodulation_novideo_sinr_dl_part1'
delay_threshold = 1
...
# NOTE: In part 1, we only train for BPSK and QPSK
'''
...
dl_df = pd.concat([dl_df_bpsk, dl_df_qpsk], ignore_index=True)
