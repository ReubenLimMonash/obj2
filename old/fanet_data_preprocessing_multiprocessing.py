...
def process_sim_data_v2(sim_root_path, delay_threshold, save_path):
    ...
    NP = 50000 # The number of packets set in the simulation for each 100m (refer to OMNeT++ ini sim file)
...
if __name__ == "__main__":
    '''
    MAKE SURE TO SET "NP" and "sending_interval_range" in function process_sim_data_v2
    '''
    # sim_root_path = "/media/research-student/One Touch/FANET Datasets/Dataset_NP10000_BPSK_6-5Mbps/Dataset_NP10000_BPSK_6-5Mbps_24UAVs"
    # save_path = "/media/research-student/One Touch/FANET Datasets/Dataset_NP10000_BPSK_6-5Mbps/Dataset_NP10000_BPSK_6-5Mbps_24UAVs_processed"
    sim_root_path = "/media/research-student/One Touch/FANET Datasets/Dataset_NP50000_BPSK_6-5Mbps_8UAVs_additional_data"
    save_path = "/media/research-student/One Touch/FANET Datasets/Dataset_NP50000_BPSK_6-5Mbps_8UAVs_additional_data_processed"
