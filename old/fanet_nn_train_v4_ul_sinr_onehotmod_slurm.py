...
Modified: Use One-Hot encoding for modulation
'''
...
checkpoint_filepath = '/home/rlim0005/nn_checkpoints/nn_v4_multimodulation_novideo_sinr_onehotmod_ul'
delay_threshold = 1
...
ul_df_bpsk = pd.read_csv("/home/rlim0005/FANET_Dataset/Dataset_NP10000_MultiModulation_Hovering_NoVideo_BPSK_uplink.csv",
...
ul_df_qpsk = pd.read_csv("/home/rlim0005/FANET_Dataset/Dataset_NP10000_MultiModulation_Hovering_NoVideo_QPSK_uplink.csv",
                    usecols = ["Mean_SINR", "Std_Dev_SINR", "Num_Members", "UAV_Sending_Interval", "Incorrectly_Received", "Queue_Overflow",
                               "Packet_State", "Delay", "U2G_H_Dist", "Height"],
                    dtype=df_dtypes)
...
ul_df_qam16 = pd.read_csv("/home/rlim0005/FANET_Dataset/Dataset_NP10000_MultiModulation_Hovering_NoVideo_QAM16_uplink.csv",
                    usecols = ["Mean_SINR", "Std_Dev_SINR", "Num_Members", "UAV_Sending_Interval", "Incorrectly_Received", "Queue_Overflow",
                               "Packet_State", "Delay", "U2G_H_Dist", "Height"],
                    dtype=df_dtypes)
...
ul_df_qam64 = pd.read_csv("/home/rlim0005/FANET_Dataset/Dataset_NP10000_MultiModulation_Hovering_NoVideo_QAM64_uplink.csv",
                    usecols = ["Mean_SINR", "Std_Dev_SINR", "Num_Members", "UAV_Sending_Interval", "Incorrectly_Received", "Queue_Overflow",
                               "Packet_State", "Delay", "U2G_H_Dist", "Height"],
                    dtype=df_dtypes)
...
# ----------------------------------------------------------------------------------------------
# packet_state_train = data_df_test['Packet_State'].values
packet_state_test = data_df_test['Packet_State'].values
packet_state_train_all = ul_df['Packet_State'].values
...
with open(os.path.join(checkpoint_filepath, 'trainHistoryDict_11052023'), 'wb') as file_pi:
