...
checkpoint_filepath = '/home/rlim0005/nn_checkpoints/nn_v3_hovering'
delay_threshold = 0.04
# checkpoint_filepath = "/home/research-student/omnet-fanet/nn_checkpoints"

# Compile all data
# dl_df_8uav = pd.read_csv("/home/rlim0005/FANET_Dataset/Dataset_NP10000_BPSK_6-5Mbps_8UAVs_processed_downlink.csv")
# dl_df_16uav = pd.read_csv("/home/rlim0005/FANET_Dataset/Dataset_NP10000_BPSK_6-5Mbps_16UAVs_processed_downlink.csv")
# dl_df_24uav = pd.read_csv("/home/rlim0005/FANET_Dataset/Dataset_NP10000_BPSK_6-5Mbps_24UAVs_processed_downlink.csv")
# dl_df_32uav = pd.read_csv("/home/rlim0005/FANET_Dataset/Dataset_NP10000_BPSK_6-5Mbps_32UAVs_processed_downlink.csv")
# dl_df_40uav = pd.read_csv("/home/rlim0005/FANET_Dataset/Dataset_NP10000_BPSK_6-5Mbps_40UAVs_processed_downlink.csv")
...
X_train_all = data_df[["U2G_H_Dist", "Height", "Num_Members", "Bytes", "Sending_Interval"]].values
