...
def process_dropped_packets_v7(tx_df, rx_df, pd_df_list, h_dist):
    '''
    Date: 2/2/2023
    ...
    rx_df: Rx DF
    pd_df_list: List of packet drop DFs, first one is for GCS, second for GW, subsequent DFs in the list for UAV 1, 2, ...
    h_dist: Horizontal distance (as inferred from the recorded distance on file name)
...
def process_scenario_v2(scenario, sim_root_path, delay_threshold, save_path, sending_interval_range=192, GX_GCS=500):
    '''
    GX_GCS is the x-coordinate of GCS. 
    '''
    # If processed file exist, skip (for rdebugging problem)
    ...
    uavs_rx_df = process_received_packets_v3(uavs_rx_df, pd_df_list, delay_threshold)
    
    dl_df = process_dropped_packets_v7(gcs_tx_df, uavs_rx_df, pd_df_list, h_dist)
    ...
    gcs_rx_df = process_received_packets_v3(gcs_rx_df, pd_df_list, delay_threshold)

    ul_df = process_dropped_packets_v7(uavs_tx_df, gcs_rx_df, pd_df_list, h_dist)
...
def process_sim_data_v2(sim_root_path, delay_threshold, save_path):
    ...
    with Pool(25) as pool:
        pool.starmap(process_scenario_v2, zip(scenario_list, repeat(sim_root_path), repeat(delay_threshold), repeat(save_path), repeat(sending_interval_range), repeat(GX_GCS)))
...
if __name__ == "__main__":
    ...
    '''
    # sim_root_path = "/media/research-student/One Touch/FANET Datasets/Dataset_NP10000_64QAM_65Mbps_Hovering/8UAVs"
    # save_path = "/media/research-student/One Touch/FANET Datasets/Dataset_NP10000_64QAM_65Mbps_Hovering/8UAVs_processed"
    sim_root_path = "/media/research-student/One Touch/FANET Datasets/Test_Dataset_NP10000_64QAM_65Mbps"
    save_path = "/media/research-student/One Touch/FANET Datasets/Test_Dataset_NP10000_64QAM_65Mbps_processed"
