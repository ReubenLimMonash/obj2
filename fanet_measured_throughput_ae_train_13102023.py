...
Desc: To train an autoencoder for measured throughput anomaly detection
...
def build_ae_model():
    ...
    encoder = Dense(12, activation='relu', name='encoder')(inputs)
    latent = Dense(6, activation='relu', name='latent')(encoder)
    decoder = Dense(12, activation='relu', name='decoder')(latent)
    recon_in = Dense(6, activation='linear', name='reconstructed_inputs')(decoder)
...
if __name__ == "__main__":
    ...
    TEST_SPLIT = 0.2
    CHECKPOINT_FILEPATH = '/home/wlau0003/Reuben_ws/nn_checkpoints/djispark_throughput_anomaly_medium_ae_dl'
    ...
    history = model.fit(X_train, X_train, epochs=EPOCHS, batch_size=BATCHSIZE, callbacks=[model_checkpoint_callback, ClearMemory()], validation_data=(X_train, X_train))
