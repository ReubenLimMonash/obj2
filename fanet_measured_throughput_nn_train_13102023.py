...
def build_nn_model_v4_wobatchnorm():
    ...
    base = Dense(25, activation='relu')(base)
    base = Dense(10, activation='relu')(base)
    throughput_anomaly = Dense(1, activation='linear', name='throughput_anomaly')(base)
    model = Model(inputs=inputs, outputs = throughput_anomaly)
    return model
...
if __name__ == "__main__":
    ...
    TEST_SPLIT = 0.2
    CHECKPOINT_FILEPATH = '/home/wlau0003/Reuben_ws/nn_checkpoints/djispark_throughput_anomaly_nnv4_wobn_dl'
    ...
    history = model.fit(X_train, y_train, epochs=EPOCHS, batch_size=BATCHSIZE, callbacks=[model_checkpoint_callback, ClearMemory()], validation_data=(X_test, y_test))
