...
def mdp_nn_both(dl_model, ul_model, vid_model, height, reliability_th=0.99, horizontal_dist=None, save_file=None):
    """
...
def run_mdp(height, max_hdist_df, hdist_step_size, dl_model_path, ul_model_path, vid_model_path, reliability_th, save_path):
    ...
    if max_hdist > 0:
        ...
        mdp_nn_both(dl_model, ul_model, vid_model, height, reliability_th=reliability_th, horizontal_dist=hdist, save_file=save_file)
...
if __name__ == "__main__":
    ...
    # initial placeholder params (run_mdp will derive actual initial pair from ground truth inside mdp function)
