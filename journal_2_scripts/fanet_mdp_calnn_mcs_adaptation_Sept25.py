...
def mdp_nn(dl_model, ul_model, vid_model, dl_T, ul_T, vid_T, height, usi, reliability_th=0.99, horizontal_dist = None, save_file=None):
    '''
    ...
    # TODO Find initial MCS using ground truth data
    ...
    #     print(height, usi, horizontal_dist[-1])
    #     return
...
def run_mdp(height, usi, max_hdist_df, hdist_step_size, dl_model_path, ul_model_path, vid_model_path, 
    ...
    if max_hdist > 0: # Exclude test cases with 0 max hdist 
        ...
        mdp_nn(dl_model, ul_model, vid_model, dl_T, ul_T, vid_T, height, usi, reliability_th=reliability_th, horizontal_dist=hdist, save_file=save_file)
