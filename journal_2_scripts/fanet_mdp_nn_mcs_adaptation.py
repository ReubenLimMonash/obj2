...
def mdp_nn(dl_model, ul_model, vid_model, reliability_th=0.99, horizontal_dist = None, heights=None, uav_send_ints=None, save_file=None, end_at_max=False):
    '''
...
def run_mdp(uav_speed, height, usi, max_hdist_df, hdist_step_size, nodes, dl_model_path, ul_model_path, vid_model_path, reliability_th, scenario_script_path):
    # Load models
    ...
    if pd.isna(max_hdist): # For case test cases with 0 max hdist
        max_hdist = 5 # Set to 5 m. Remember to exclude this test case from the results
    ...
    mdp_actions = mdp_nn(dl_model, ul_model, vid_model,
...
if __name__ == "__main__":
    ...
    # SCENARIO_SCRIPT_PATH = "/home/research-student/omnet-fanet/scenario_scripts_mcs_adaptation/scenario_scripts_1m_nn_90"
    ...
    SCENARIO_SCRIPT_PATH = "/home/clow0003/Reuben_ws/scenario_scripts_mcs_adaptation/scenario_scripts_1m_nn_999_v2"
