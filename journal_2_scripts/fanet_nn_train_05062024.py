...
if __name__ == "__main__":
    ...
    LINK = "Downlink"
    # CHECKPOINT_FILEPATH = '/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/nn_ckpts'
    # DATASET_PATH = "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/data_processed/{}_Reliability.csv"
    CHECKPOINT_FILEPATH = '/home/clow0003/Reuben_ws/FANET_Dataset/Dataset_NP100000_DJIMavicAir/nn_ckpts'
    DATASET_PATH = "/home/clow0003/Reuben_ws/FANET_Dataset/Dataset_NP100000_DJIMavicAir/data_processed/{}_Reliability.csv"
    ...
    for j in range(ROUNDS):
        for i in range(NUM_SPLIT):
            ...
            with open(os.path.join(CHECKPOINT_FILEPATH, '{}_trainHistoryDict.round-{}_split-{}'.format(LINK,j,i)), 'wb') as file_pi:
