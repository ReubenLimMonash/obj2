...
def run_mdp(uav_speed, usi, mcs, init_height, heights, max_hdist_df, hdist_step_size, nodes, 
            dl_model_path, ul_model_path, vid_model_path, dl_T, ul_T, vid_T, reliability_th, 
    ...
    if (not pd.isna(max_hdist)) & (max_hdist > 0): # Exclude test cases with 0 max hdist
        ...
        mdp_write_actions_2_xml(mdp_actions, nodes, uav_speed, scenario_script_file, adapt_usi=True, adapt_mcs=True)
...
if __name__ == "__main__":
    ...
    SCENARIO_SCRIPT_PATH = "/home/research-student/omnet-fanet/scenario_scripts_height_adaptation/scenario_scripts_1m_calibrated_4_specificity_99"
    BONN_MOTION_PATH = "/home/research-student/omnet-fanet/bonn_motion_height_adaptation/bonn_motion_1m_calibrated_4_specificity_99"
    RELIABILITY_TH = 0.99
