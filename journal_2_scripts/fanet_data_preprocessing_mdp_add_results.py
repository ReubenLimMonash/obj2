...
Modified from fanet_data_preprocessing_mdp_adaptation_reliability.py
Modified: To add results from more simulation runs for test cases with existing processed results
'''
...
def process_scenario_v4(scenario_path, save_path, num_processes, 
    ...
    results_df = pd.read_csv(os.path.join(save_path, scenario, "Simulation_Results.csv"))
    results_df = pd.concat([results_df, metric_df], ignore_index=True)
    results_df.to_csv(os.path.join(save_path, scenario, "Simulation_Results.csv"), index=False)
...
if __name__ == "__main__":
    ...
    # sim_root_path = "/media/research-student/KingstonSSD/mcs_adaptation_results/bn_proposed_99"
    # save_path = "/media/research-student/KingstonSSD/mcs_adaptation_results/bn_proposed_99_processed"
    sim_root_path = "/home/wlau0003/Reuben_ws/FANET_Dataset/mcs_adaptation_results/nn_proposed_99"
    save_path = "/home/wlau0003/Reuben_ws/FANET_Dataset/mcs_adaptation_results/nn_proposed_99_processed"
