'''
Date: 15/07/2024
Desc: To retrain the final model using different random seed
Midified from fanet_nn_train_05062024.py
'''
...
if __name__ == "__main__":
    ...
    BATCHSIZE = 64
    NUM_SPLIT = 10 # Number of splits for dataset details
    LR = 0.001 # Adam Learning Rate
    L1_REG = 0.001 # L1 Norm Weight Regularization
    LINK = "Uplink"
    # CHECKPOINT_FILEPATH = '/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_ParrotAR2/nn_ckpts_retrain'
    # MODEL_PATH = "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_ParrotAR2/nn_ckpts/model_Downlink.round-1_split-8_0.2319.h5"
    # DATASET_PATH = "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_ParrotAR2/data_processed/{}_Reliability.csv"
    CHECKPOINT_FILEPATH = '/home/wlau0003/Reuben_ws/FANET_Dataset/Dataset_NP100000_ParrotAR2/nn_ckpts_retrain'
    MODEL_PATH = "/home/wlau0003/Reuben_ws/FANET_Dataset/Dataset_NP100000_ParrotAR2/nn_ckpts/model_{}.round-1_split-8_0.1269.h5".format(LINK)
    DATASET_PATH = "/home/wlau0003/Reuben_ws/FANET_Dataset/Dataset_NP100000_ParrotAR2/data_processed/{}_Reliability.csv".format(LINK)
    ...
    dataset_details_df = pd.read_csv(DATASET_PATH, 
                                usecols = ["Horizontal_Distance", "Mean_SINR", "Std_Dev_SINR", "UAV_Sending_Interval", "Modulation", "Bitrate", 
    ...
    for j in range(ROUNDS):
        for i in range(NUM_SPLIT):
            ...
            dataset_split = dataset_split.loc[dataset_split["Horizontal_Distance"] <= 700] # Only consider Horizontal_Distance <= 700
            ...
            model_checkpoint_callback = keras.callbacks.ModelCheckpoint(
                filepath=os.path.join(CHECKPOINT_FILEPATH,"model_{}.round-{}_split-{}_{{val_loss:.4f}}.h5".format(LINK,j,i)),
            ...
            with open(os.path.join(CHECKPOINT_FILEPATH, '{}_trainHistoryDict.round-{}_split-{}_seed-{}'.format(LINK,j,i,seed)), 'wb') as file_pi:
                pickle.dump(history.history, file_pi)

    # Save final model
    model.save(os.path.join(CHECKPOINT_FILEPATH,"{}_final_model.h5".format(LINK)))