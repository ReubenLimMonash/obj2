"""
Date: 01/11/2025
Desc: To perform NN calibration for models trained for cross-validation
       Definition of positive class: reliability below threshold
       Metrics for calibration: sensitivity
"""
...
def objective_specificity(T, X_train, y_train, reliability_th):
    ...
    """
    calibrated_reliability_prediction = np.array([activations.softmax(K.constant([logits/T]), axis=-1)[0][0].numpy() for logits in X_train])
    calibrated_reliability_state = calibrated_reliability_prediction < reliability_th # This has been updated for new def of positive class
...
if __name__ == "__main__":
    ...
    MODEL_PATHS = ["/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/kfold_nn_ckpts/Downlink_kfold_0_final_model.h5",
                    ...
                    "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/kfold_nn_ckpts/Uplink_kfold_0_final_model.h5",
                    ...
                    "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/kfold_nn_ckpts/Video_kfold_0_final_model.h5",
    ...
    DATASET_PATHS = ["/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/data_processed_kfold/Downlink_Reliability_kfold_0_train.csv",
                    "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/data_processed_kfold/Downlink_Reliability_kfold_1_train.csv",
                    "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/data_processed_kfold/Downlink_Reliability_kfold_2_train.csv",
                    "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/data_processed_kfold/Downlink_Reliability_kfold_3_train.csv",
                    "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/data_processed_kfold/Downlink_Reliability_kfold_4_train.csv",
                    "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/data_processed_kfold/Uplink_Reliability_kfold_0_train.csv",
                    "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/data_processed_kfold/Uplink_Reliability_kfold_1_train.csv",
                    "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/data_processed_kfold/Uplink_Reliability_kfold_2_train.csv",
                    "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/data_processed_kfold/Uplink_Reliability_kfold_3_train.csv",
                    "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/data_processed_kfold/Uplink_Reliability_kfold_4_train.csv",
                    "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/data_processed_kfold/Video_Reliability_kfold_0_train.csv",
                    "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/data_processed_kfold/Video_Reliability_kfold_1_train.csv",
                    "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/data_processed_kfold/Video_Reliability_kfold_2_train.csv",
                    "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/data_processed_kfold/Video_Reliability_kfold_3_train.csv",
                    "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/data_processed_kfold/Video_Reliability_kfold_4_train.csv"]
    # NOTE: Make sure SAVE_PATHS correspond to MODEL_PATHS
    metric = "sensitivity"
    RELIABILITY_TH = 0.999
    REL_TH_STR = 999
    SAVE_PATHS = ["/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/kfold_nn_calibration/dl_calibration_T_kfold_0_{}_{}.pkl".format(metric, REL_TH_STR),
                "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/kfold_nn_calibration/dl_calibration_T_kfold_1_{}_{}.pkl".format(metric, REL_TH_STR),
                "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/kfold_nn_calibration/dl_calibration_T_kfold_2_{}_{}.pkl".format(metric, REL_TH_STR),
                "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/kfold_nn_calibration/dl_calibration_T_kfold_3_{}_{}.pkl".format(metric, REL_TH_STR),
                "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/kfold_nn_calibration/dl_calibration_T_kfold_4_{}_{}.pkl".format(metric, REL_TH_STR),
                "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/kfold_nn_calibration/ul_calibration_T_kfold_0_{}_{}.pkl".format(metric, REL_TH_STR),
                "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/kfold_nn_calibration/ul_calibration_T_kfold_1_{}_{}.pkl".format(metric, REL_TH_STR),
                "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/kfold_nn_calibration/ul_calibration_T_kfold_2_{}_{}.pkl".format(metric, REL_TH_STR),
                "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/kfold_nn_calibration/ul_calibration_T_kfold_3_{}_{}.pkl".format(metric, REL_TH_STR),
                "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/kfold_nn_calibration/ul_calibration_T_kfold_4_{}_{}.pkl".format(metric, REL_TH_STR),
                "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/kfold_nn_calibration/vid_calibration_T_kfold_0_{}_{}.pkl".format(metric, REL_TH_STR),
                "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/kfold_nn_calibration/vid_calibration_T_kfold_1_{}_{}.pkl".format(metric, REL_TH_STR),
                "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/kfold_nn_calibration/vid_calibration_T_kfold_2_{}_{}.pkl".format(metric, REL_TH_STR),
                "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/kfold_nn_calibration/vid_calibration_T_kfold_3_{}_{}.pkl".format(metric, REL_TH_STR),
                "/media/research-student/KingstonSSD/FANET_Dataset/Dataset_NP100000_DJISpark/kfold_nn_calibration/vid_calibration_T_kfold_4_{}_{}.pkl".format(metric, REL_TH_STR)]
    SAVE_FILE = "kfold_nn_calibration/nn_calibration_T_{}_{}.csv".format(metric, REL_TH_STR)
