...
def process_dropped_packets_v7(tx_df, rx_df, pd_df_list, h_dist, height):
    uav_radius = 5
    '''
    Date: 2/2/2023
    ...
    for row in tqdm(tx_df_failed_dict):
        ...
        if not pkt_drops.empty: # Find the packet drops for this particular packet
            ...
            failed_pkt = {'RxTime': rx_time,'TxTime': tx_time,'Packet_Name': packetName,'Bytes': bytes,'U2G_SINR': u2g_sinr,'U2G_BER': u2g_ber,
                          'Dest_Addr': dest_addr,'U2G_Distance': u2g_distance,'Retry_Count': len(drop_reasons),'Delay': delay, 
                          'Incorrectly_Received': incorrect_rcvd,'Queue_Overflow': queue_overflow,'Packet_State': pkt_state}
...
def process_scenario_v2(scenario, sim_root_path, dl_delay_threshold, ul_delay_threshold, save_path, GX_GCS=500):
    '''
    ...
    dl_df = process_dropped_packets_v7(gcs_tx_df, uavs_rx_df, pd_df_list, h_dist=h_dist, height=height)
    ...
    ul_df = process_dropped_packets_v7(uavs_tx_df, gcs_rx_df, pd_df_list, h_dist=h_dist, height=height)
...
if __name__ == "__main__":
    ...
    '''
    sim_root_path = "/media/research-student/One Touch/FANET Datasets/Test_Dataset_NP10000_64QAM_65Mbps_Hovering_NoVideo"
    save_path = "/media/research-student/One Touch/FANET Datasets/Test_Dataset_NP10000_64QAM_65Mbps_Hovering_NoVideo_processed"
    # sim_root_path = "/home/rlim0005/FANET_Dataset/Dataset_NP10000_64QAM_65Mbps_Hovering_NoVideo"
    # save_path = "/home/rlim0005/FANET_Dataset/Dataset_NP10000_64QAM_65Mbps_Hovering_NoVideo_processed"
