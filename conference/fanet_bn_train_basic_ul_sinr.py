...
# Training params
save_cpt_filepath = '/home/research-student/omnet-fanet/cpt/bn_basic_multimodulation_novideo_sinr_ul'
delay_threshold = 1
...
ul_df["Mean_SINR_Class"] = pd.cut(ul_df.Mean_SINR, sinr_class_bnd, right=False, include_lowest=True, labels=sinr_labels)
ul_df["Std_Dev_SINR_Class"] = pd.cut(ul_df.Std_Dev_SINR, sinr_class_bnd, right=False, include_lowest=True, labels=sinr_labels)
